...
const categories = ["All", "Hostel Platform", "Fintech", "Retail POS", "E-Commerce"];

const projects = [
  {
    title: "UniHive – Hostel Booking Platform",
    category: "Hostel Platform",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <p className="text-zinc-400 max-w-xl">
              Production solutions engineered by CYYBRID Technology for university housing, financial tech, retail inventory, and e-commerce.
            </p>
          </div>
          <a
